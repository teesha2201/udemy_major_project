           ...
           < DevelopmentRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst"> Development Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {web.filter((item,index)=>(item.id===42)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {web.filter((item,index)=>(item.id===43)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {web.filter((item,index)=>(item.id===44)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {web.filter((item)=>(item.id>44) && (item.id<48)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {web.filter((item)=>(item.id>47) && (item.id<53)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
