           ...
           {/* <img src=""/> */}
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Bussiness Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {bussiness.filter((item,index)=>(item.id===74)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {bussiness.filter((item,index)=>(item.id===75)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {bussiness.filter((item,index)=>(item.id===76)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {bussiness.filter((item,index)=>(item.id===77)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {bussiness.filter((item)=>(item.id>77) && (item.id<81)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {bussiness.filter((item)=>(item.id>81) && (item.id<87)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
