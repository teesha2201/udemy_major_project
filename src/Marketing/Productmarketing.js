           ...
           < MarketingRoute/>
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Product Marketing Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===344)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===345)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===349)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===348)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {market.filter((item)=>(item.id>342) && (item.id<346)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {market.filter((item)=>(item.id>346) && (item.id<352)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
