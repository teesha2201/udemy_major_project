...
import MarketingRoute from "./MarketRoute";
           ...
           < MarketingRoute/>
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Public Marketing Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===352)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===353)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===354)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===355)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
            ...
            <div className="tablecontainer">
                ...
                <div className="populartopics">
                    <div><NavLink to="/marketing/digitalmarketing" className="nav">Digital Marketing</NavLink></div>
                    <div> <NavLink to="/marketing/contentmarketing" className="nav">Content Marketing</NavLink></div>
                    <div><NavLink to="/marketing/socialmediamarketing" className="nav">Social Media Marketing</NavLink></div>
                    <div><NavLink to="/marketing/productmarketing" className="nav">Product Marketing</NavLink></div>
                    <div><NavLink to="/marketing/publicmarketing" className="nav">Public Marketing</NavLink></div>
                </div>
            </div>
            {/* popularInstructor */}
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {market.filter((item)=>(item.id>352) && (item.id<356)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {market.filter((item)=>(item.id>355) && (item.id<361)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
...
export default PublicMarketing