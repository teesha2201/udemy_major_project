           ...
           < MarketingRoute/>
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Social Marketing Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===309)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===322)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===311)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {market.filter((item)=>(item.id>324) && (item.id<328)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {market.filter((item)=>(item.id>327) && (item.id<333)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
