           ...
           < MarketingRoute/>
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Digital Marketing Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===318)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===312)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===313)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {market.filter((item,index)=>(item.id===314)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {market.filter((item)=>(item.id>310) && (item.id<314)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {market.filter((item)=>(item.id>320) && (item.id<326)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
