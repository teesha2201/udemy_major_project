...
import TeachingRoute from "./TeachingRoute";
           ...
           <TeachingRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Teaching & Academic Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===504)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===514)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===518)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===523)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
            ...
            <div className="tablecontainer">
                ...
                <div className="populartopics">
                    <div><NavLink to="/teaching/engineering" className="nav">Engneering </NavLink></div>
                    <div><NavLink to="/teaching/socialscience" className="nav">Social Science</NavLink></div>
                    <div><NavLink to="/teaching/math" className="nav">  Math </NavLink></div>
                    <div><NavLink to="/teaching/science" className="nav">Science</NavLink></div>
                    <div><NavLink to="/teaching/teachertraining" className="nav">Teacher Training</NavLink></div>
                </div>
            </div>
            {/* popularInstructor */}
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {music.filter((item)=>(item.id>504) && (item.id<508)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {music.filter((item)=>(item.id>509) && (item.id<515)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
