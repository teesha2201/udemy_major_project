           ...
           <TeachingRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Music Courses</h1>
                ...
                <div className="web_cardrow1">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===519)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===520)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {music.filter((item,index)=>(item.id===521)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {music.filter((item)=>(item.id>521) && (item.id<525)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {music.filter((item)=>(item.id>297) && (item.id<303)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
