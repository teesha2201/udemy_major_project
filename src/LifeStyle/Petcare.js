            ...
            <div className="web_parent">
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {life.filter((item,index)=>(item.id===389)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {life.filter((item,index)=>(item.id===390)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {life.filter((item,index)=>(item.id===391)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {life.filter((item,index)=>(item.id===392)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {life.filter((item)=>(item.id>392) && (item.id<396)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {life.filter((item)=>(item.id>389) && (item.id<395)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
