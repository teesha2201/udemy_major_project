           ...
           < ITandsoftwareRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Network Courses</h1>
                ...
                <div className="web_cardrow1">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===216)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===213)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===217)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {ITsoft.filter((item)=>(item.id>215) && (item.id<219)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {ITsoft.filter((item)=>(item.id>212) && (item.id<218)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
