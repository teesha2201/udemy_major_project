           ...
           < ITandsoftwareRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">IT Certification Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===198)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===208)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===210)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===209)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {ITsoft.filter((item)=>(item.id>210) && (item.id<214)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {ITsoft.filter((item)=>(item.id>208) && (item.id<214)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
