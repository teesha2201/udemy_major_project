           ...
           < ITandsoftwareRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Operating System & Server Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===232)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===233)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===234)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===235)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {ITsoft.filter((item)=>(item.id>235) && (item.id<239)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {ITsoft.filter((item)=>(item.id>234) && (item.id<240)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
