           ...
           < ITandsoftwareRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Other IT & Software Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===221)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===246)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===240)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===244)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {ITsoft.filter((item)=>(item.id>240) && (item.id<244)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {ITsoft.filter((item)=>(item.id>244) && (item.id<250)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
