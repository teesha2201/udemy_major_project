           ...
           < ITandsoftwareRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">IT & Software Courses</h1>
                ...
                <div className="web_cardrow1">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===199)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===200)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {ITsoft.filter((item,index)=>(item.id===201)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {ITsoft.filter((item)=>(item.id>200) && (item.id<204)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {ITsoft.filter((item)=>(item.id>203) && (item.id<209)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
