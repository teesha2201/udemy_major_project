           ...
           < FinanceRoute />
            ...
            <div className="web_parent">
                <div className="web_div">
                    <h1 className="web_headingfirst">Accounting & Bookkeeping Courses</h1>
                ...
                <div className="web_cardrow1">
                                    <div className="web_cardParent1">
                                        ...
                                        {finance.filter((item,index)=>(item.id===150)).map((item,index)=>{
                                        return(
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {finance.filter((item,index)=>(item.id===169)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {finance.filter((item,index)=>(item.id===170)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
                                    ...
                                    <div className="web_cardParent1">
                                        ...
                                        {finance.filter((item,index)=>(item.id===154)).map((item,index)=>{
                                        return(
                                            <div key={index} className="web_cardContainer2">
        ...
        <div className="webcardcontainer_parent">
            <div className="webcardcontainer">
               ...
               <div className="webcardparent">
                        {finance.filter((item)=>(item.id>170) && (item.id<174)).map((item,index)=>{
                            return(
                                <>
                ...
                <div className="webcardlast">
                        {finance.filter((item)=>(item.id>154) && (item.id<160)).map((item,index)=>{
                            return(
                                <>
                                        <div className="webcard_row">
                                            <div className="webimg">
...
export default Accountingandbook
